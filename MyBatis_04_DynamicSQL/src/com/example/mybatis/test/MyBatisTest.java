...
public class MyBatisTest {
	...
	public void testBatchSave() throws IOException{
		...
		try{
			...
			emps.add(new Employee(null, "smith0x1", "smith0x1@example.com", "1",new Department(1)));
			emps.add(new Employee(null, "allen0x1", "allen0x1@example.com", "0",new Department(1)));
			mapper.addEmps(emps);
			openSession.commit();
		}finally{
			openSession.close();
	...
	public void test() throws IOException {
		...
		try {
			Employee employee = openSession.selectOne(
					"com.example.mybatis.EmployeeMapper.selectEmp", 1);
			System.out.println(employee);
		} finally {
			openSession.close();
		}
	...
	public void test03() throws IOException{
		...
		try{
			...
			//测试修改
			//Employee employee = new Employee(1, "Tom", "jerry@example.com", "0");
